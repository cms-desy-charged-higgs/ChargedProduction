...
def crabConfig(MHc, Mh, year):
    ...
    crabConf.Data.inputDataset = "/HPlusAndH_ToWHH_ToL4B_{}_{}/dbrunner-GEN-SIM-{}-8a21dfe1d11f7ecf44457d8dbded9b07/USER".format(MHc, Mh, year)
    crabConf.Data.inputDBS = "phys03"
    crabConf.Data.splitting = "EventAwareLumiBased"
    crabConf.Data.unitsPerJob = 3000
    crabConf.Data.totalUnits = crabConf.Data.unitsPerJob * 4000
